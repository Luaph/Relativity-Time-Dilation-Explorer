...
CFLAGS += -Wall -std=c99 -D_DEFAULT_SOURCE -Wno-missing-braces -Iinclude -IC:/raylib/raylib/src
...
# Automatically use all .c files in src/ as objects for the main target
...
# Rule to build object files in the project root from src/*.c
%.o: src/%.c
    $(CC) -c $< -o $@ $(CFLAGS) $(INCLUDE_PATHS) -D$(PLATFORM)

# Existing rule for obj/%.o (not used by default, but kept for reference)
$(OBJ_DIR)/%.o: $(SRC_DIR)/%.c
    $(CC) -c $< -o $@ $(CFLAGS) $(INCLUDE_PATHS) -D$(PLATFORM)
